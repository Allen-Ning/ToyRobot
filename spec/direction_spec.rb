...
module ToyRobot
  describe Direction do
    ...
    context 'should get direction name' do
      it 'should get NORTH direction name' do
      ...
      it 'should get WEST direction name' do
      ...
      it 'should get SOUTH direction name' do
    ...
    context 'should find index' do
      it 'should find NORTH direction index' do
        index = Direction.find_index(Direction::NORTH)
        expect(index).to eql(0)
      end

      it 'should find WEST direction index' do
        index = Direction.find_index(Direction::WEST)
        expect(index).to eql(1)
      end

      it 'should find SOUTH direction index' do
        index = Direction.find_index(Direction::SOUTH)
        expect(index).to eql(2)
      end

      it 'should find EAST direction index' do
        index = Direction.find_index(Direction::EAST)
        expect(index).to eql(3)
      end

      it 'should raise DirectionNameNotFoundException when using invalid direction name' do
